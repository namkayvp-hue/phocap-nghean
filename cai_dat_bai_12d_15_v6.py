...
BACKUP = PROJECT / "exports" / f"backup_bai_12d_15_v6_{STAMP}"
...
REGISTER_START = "# === BAI 12D-15 V6: BAT DAU ==="
REGISTER_END = "# === BAI 12D-15 V6: KET THUC ==="
REGISTER_BLOCK = f'''\n{REGISTER_START}
...
def run_checks() -> None:
    ...
    check_path = PROJECT / "check_bai_12d_15_v6.py"
...
try:
    print("\n" + "=" * 62)
    print("CAI DAT BAI 12D-15 V6 - DOI CHIEU DIEU TRA VOI HOC SINH")
    print("=" * 62)
    ...
    print("\n" + "=" * 62)
    print("CAI DAT BAI 12D-15 V6 THANH CONG")
    print("=" * 62)
    print("Ban sao an toan:", BACKUP)
