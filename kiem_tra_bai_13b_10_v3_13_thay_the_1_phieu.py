...
DEFAULT_SCHOOL_USERNAME = "truong_40413308"  # Trường MN Nghi Hải
...
def main() -> None:
    ...
    print("KIỂM TRA BÀI 13B-10 V3.13 - THAY THẾ/ĐIỀU CHỈNH 1 PHIẾU")
    ...
    try:
        ...
        print(
            ...
            f"household={form['household_code']} | chủ hộ={form['head_name']} | "
            f"địa chỉ={form['address']}"
        )
