...
Write-Host "COMMIT V2 QD3805-OP-0210" -ForegroundColor Yellow
...
Write-Host "MOI DU LIEU NGOAI WRITE-SET PHAI BAT BIEN" -ForegroundColor Yellow
Write-Host "==================================================================" -ForegroundColor Yellow
...
& $Py -X utf8 "C:\PhoCap\commit_thcs_op0210_v2.py"
$ExitCode = $LASTEXITCODE

Write-Host ""
Write-Host "KET QUA:" -ForegroundColor Cyan
Write-Host "C:\PhoCap\exports\COMMIT_THCS_OP0210_V2.txt" -ForegroundColor Green
