...
BACKUP = EXPORTS / f"backup_bai_13b_12_v2_4_3_6a_{STAMP}"
DB_BACKUP = BACKUP / "phocap.db"
REPORT = EXPORTS / f"bao_cao_cai_bai_13b_12_v2_4_3_6a_{STAMP}.txt"
...
def main() -> int:
    ...
    REPORT.write_text(
        "\n".join(
            [
                "=" * 124,
                "BÁO CÁO CÀI BÀI 13B-12 V2.4.3.6A",
                "=" * 124,
    ...
    print()
    print("=" * 124)
    print("CÀI ĐẶT THÀNH CÔNG BÀI 13B-12 V2.4.3.6A")
    print("=" * 124)
    print(" - MN-01-TE các ô tỷ lệ cùng hiển thị dấu %: ĐẠT.")
    print(" - Verifier chuỗi number_format: ĐẠT.")
