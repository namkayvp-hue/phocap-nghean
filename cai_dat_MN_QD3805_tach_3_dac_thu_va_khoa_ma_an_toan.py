...
def school_candidates(con, expected_name):
    ...
    for row in rows:
        school_name_raw = str(row["school_name"] or "").strip()
        ...
        # Nhánh fallback cuối cùng, không ảnh hưởng các quy tắc trước:
        ...
        # Fallback cuối cùng cho lỗi dính chữ trong dữ liệu nguồn:
        #   "Mầm nonThanh Hà"
        # thay vì
        #   "Mầm non Thanh Hà"
        #
