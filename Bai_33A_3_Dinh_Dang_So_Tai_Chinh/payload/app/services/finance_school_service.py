...
def fill_finance_worksheet(
    ...
    *,
    ...
    # === BAI_33A_3_FINANCE_NUMBER_FORMAT_START ===
    # Excel chỉ làm gọn phần HIỂN THỊ tối đa 2 chữ số thập phân.
    # Giá trị thực ghi vào ô/DB không bị làm tròn hay thay đổi.
    finance_number_format = "#,##0.##"
    for row in range(10, 40):
        for col in range(4, 10):
            cell = ws.cell(row, col)
            cell.value = None
            cell.number_format = finance_number_format
    # === BAI_33A_3_FINANCE_NUMBER_FORMAT_END ===
