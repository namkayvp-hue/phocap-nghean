# -*- coding: utf-8 -*-
r"""
DRY-RUN V10.8 - CHUẨN BỊ NẠP BASELINE HỌC SINH 2025-2026 QĐ 3805
==================================================================
...
SOURCE_BUNDLE = ROOT / "uploads" / "Nguon_HS_2025_2026_Nghi_Loc_QD3805.zip"
...
def main() -> None:
    print("=" * 126)
    print("DRY-RUN V10.8 - CHUẨN BỊ NẠP BASELINE HỌC SINH 2025-2026 QĐ3805")
    print("=" * 126)
    ...
    if not SOURCE_BUNDLE.exists():
        raise AuditAbort(
            ...
            f"  {SOURCE_BUNDLE}\n"
            "Hãy chép file Nguon_HS_2025_2026_Nghi_Loc_QD3805.zip vào C:\\PhoCap\\uploads."
        )
    ...
    with zipfile.ZipFile(SOURCE_BUNDLE) as z:
        ...
        missing = [name for name in FILES.values() if name not in names]
        if missing:
            raise AuditAbort(
    ...
    out_dir = ROOT / f"dry_run_baseline_HS_QD3805_v10_8_{ts}"
    ...
    try:
        ...
        write_csv(
            ...
            ["level", "file", "student_rows_detected"],
            source_file_rows,
        )
        write_csv(
        ...
        write_csv(
            out_dir / "508_GATE_V10_8.csv",
            ["check", "result", "detail"],
            gate_rows,
        )

        summary = out_dir / "00_TONG_QUAN_V10_8.txt"
        with summary.open("w", encoding="utf-8") as f:
            f.write(
                "DRY-RUN V10.8 - CHUẨN BỊ NẠP BASELINE HỌC SINH 2025-2026 QĐ3805\n"
            )
            f.write("=" * 126 + "\n")
        ...
        zip_path = ROOT / f"dry_run_baseline_HS_QD3805_v10_8_{ts}.zip"
        ...
        print()
        print("=" * 126)
        print("HOÀN THÀNH DRY-RUN V10.8")
        print("=" * 126)
...
if __name__ == "__main__":
    try:
        ...
        print()
        print("=" * 126)
        print("LỖI KHÔNG DỰ KIẾN TRONG V10.8")
        print("=" * 126)
        print(repr(exc))
        print("Database / file nguồn / mã nguồn: KHÔNG bị thay đổi.")
        sys.exit(4)
