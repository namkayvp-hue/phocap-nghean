...
# === BAI_13B_9_V1A_ACCESS_ACTION_END ===
        ...
        # === BAI_33A_1_SCHOOL_FINANCE_POST_ACCESS_START ===
        # BC-Tài chính: Sở/Xã/Trường được xem. Chỉ tài khoản TRƯỜNG
        # được POST dữ liệu; router tiếp tục khóa school_id đúng trường đăng nhập.
        if normalized_path == "/bao-cao/tai-chinh/nhap":
            if method in SAFE_METHODS:
                return role_code in {
                    *ADMIN_ROLE_CODES,
                    DEPARTMENT_ROLE_CODE,
            ...
            return role_code == SCHOOL_ROLE_CODE
        # === BAI_33A_1_SCHOOL_FINANCE_POST_ACCESS_END ===
