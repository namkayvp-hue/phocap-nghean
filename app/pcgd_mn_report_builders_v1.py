...
def export_mn_report(*, report_type: str, db: Session, request: Any, school_year: SchoolYear | None, selected_commune_id: int | None, selected_school_id: int | None, scope_label: str) -> StreamingResponse:
    ...
    output = BytesIO()
    # === BAI_13B_11_15_2_4_6_LEGACY_POSTPROCESS ===
    ...
    # === BAI_13B_11_15_2_4_9_2_MN_CALL_START ===
    ...
    # === BAI_13B_11_15_2_4_9_2_MN_CALL_END ===
    # === BAI_13B_11_15_2_4_9_2A_1_MN_CALL_START ===
    _b492a1_format_mn_percent_display(
        ws,
        report_type,
    )
    # === BAI_13B_11_15_2_4_9_2A_1_MN_CALL_END ===
