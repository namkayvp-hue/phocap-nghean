...
OUT = EXPORTS / "KHAO_SAT_DOI_CHIEU_HOC_SINH_CAP_TRUONG_31C1.txt"
JSON_OUT = EXPORTS / "KHAO_SAT_DOI_CHIEU_HOC_SINH_CAP_TRUONG_31C1.json"
        ...
        if isinstance(node, (ast.FunctionDef, ast.AsyncFunctionDef)):
            ...
            if decorators:
                result["routes"].append({
                    ...
                    "context": context(lines=text, line_no=node.lineno, before=4, after=18),
                })
...
def main():
    ...
    with OUT.open("w", encoding="utf-8-sig", newline="\n") as f:
        log(f, "=" * 190)
        log(f, "BÀI 31C1 - KHẢO SÁT NGHIỆP VỤ ĐỐI CHIẾU HỌC SINH TỪ CẤP TRƯỜNG")
