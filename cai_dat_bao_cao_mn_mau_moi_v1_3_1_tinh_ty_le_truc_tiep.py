...
BACKUP = (
    PROJECT
    / "exports"
    / f"backup_bao_cao_mn_ty_le_v1_3_1_{STAMP}"
)
...
def main() -> int:
    print("=" * 118)
    print(
        "BÁO CÁO MẦM NON MẪU MỚI V1.3.1 - "
    ...
    print()
    print("V1.3.1 SỬA LỖI BỘ CÀI:")
    print(
        " - Không còn kiểm tra cứng chuỗi "
        "'Trẻ 3,4 tuổi'."
    )
    print(
        " - Kiểm tra theo các biến row_34_* "
        "nên không phụ thuộc khoảng trắng trong nhãn."
    )
    print()
    print("V1.3 SỬA:")
    print(
