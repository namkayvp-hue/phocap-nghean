# -*- coding: utf-8 -*-
r"""
V13.2 - PHÂN LOẠI + ĐỐI CHIẾU NGUỒN SÁP NHẬP TOÀN TỈNH
========================================================

MỤC TIÊU
--------
Đọc file "Nguồn sáp nhập.xlsx", phân nhóm toàn bộ phương án và đối chiếu
...
----
cd C:\PhoCap
.\.venv\Scripts\python.exe .\phan_loai_doi_chieu_sap_nhap_toan_tinh_v13_2.py
"""
...
SOURCE_CANDIDATES = [
    ROOT / "uploads" / "Nguồn sáp nhập.xlsx",
    ROOT / "Nguồn sáp nhập.xlsx",
    Path.home() / "Downloads" / "Nguồn sáp nhập.xlsx",
]
...
def locate_source() -> Path:
    ...
    raise AuditStop(
        "Không tìm thấy file 'Nguồn sáp nhập.xlsx'.\n"
        "Hãy chép file vào một trong các vị trí:\n- "
...
def main() -> int:
    ...
    out_dir = ROOT / f"bao_cao_v13_2_sap_nhap_toan_tinh_{stamp}"
    zip_path = ROOT / f"bao_cao_v13_2_sap_nhap_toan_tinh_{stamp}.zip"
    ...
    try:
        ...
        summary = out_dir / "00_TONG_QUAN_V13_2.txt"
